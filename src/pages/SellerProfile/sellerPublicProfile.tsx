...
import badgeIcon from "../../assets/icons/Group 13782 (1).svg"; // use as Bronze + avatar medal
...
import shieldIcon from "../../assets/icons/shield-check-svgrepo-com (1).svg"; // Silver
...
const sellerPublicProfile: React.FC = () => {
  ...
  if (error || !data) {
    return (
      <p className="text-black flex justify-center items-center font-semibold text-xl text-center">
        This profile is not yet public or access is restricted
      </p>
    );
  }
  ...
  // Trust-tier badges like on SellerProfile
      ...
      <div className="relative -mt-[60px] md:-mt-[50px] z-[100]">
        <section className="text-black w-full">
          <div className="w-full flex flex-col gap-6 rounded-lg py-12 sm:px-10 px-6 relative bg-white border-2">
            {/* Header */}
            <div className="border-b-2 pb-4 flex justify-between items-start gap-1">
              <div className="flex flex-row gap-2 sm:gap-6 items-start w-max">
                ...
                <div className="mt-2">
                  ...
                  <div className="flex flex-row gap-1 sm:items-center sm:justify-start">
                    <img
                      src={starIcon}
                      alt="Trust Score star"
                      className="sm:w-6 sm:h-6 w-4 h-4 text-center mt-0.5"
                    />
                    <p className="font-bold text-nowrap sm:text-lg text-center w-max">
                      {trustScore}
                      <span className="text-gray-500 text-center font-bold text-xs sm:text-sm mx-1">
                        Trust Score
                      </span>
                    </p>
                  </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-xs text-gray-600">
                    Based on seller&apos;s trust score of {trustScore}/100.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full bg-white border-2 rounded-lg p-4 sm:p-6 mt-6 flex flex-col gap-4">
            ...
            <div className="flex justify-between sm:gap-6 gap-2 w-full flex-wrap">
              <div className="border-2 border-gray-300 flex-1 h-auto rounded-xl p-4 flex flex-col justify-center text-center shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <span className="font-bold sm:text-2xl text-sm text-center">
              ...
              <div className="border-2 border-gray-300 flex-1 h-auto rounded-xl p-4 flex flex-col justify-center text-center shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                ...
                <p className="text-gray-400 text-sm font-semibold">
                  {trustTierLabel[trustTier]} Level
                </p>
              </div>
            </div>
          </div>
